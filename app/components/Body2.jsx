            ...
            <div className="p-5 min-h-[50vh]">
                ...
                <div className="h-full text-center">
                    ...
                    <p className={`text-lg pt-[2vh] ${ovo.className}`}>Plan your own trip? Whether it’s for seniors, couples, or families — 
                        <a  onClick={() => goToForm(1)} className="text-blue-500 active:text-red-700 underline cursor-pointer text-2xl"> Click here </a>to start booking.</p>
                ...
                <div className="pt-[2vh] text-center">
                    ...
                    <p className={`text-lg pt-[2vh] p-2 ${ovo.className}`}>Want to join one of our hosted adventures? 
                        <a  onClick={() => goToForm(2)} className="text-blue-500 active:text-red-700 underline cursor-pointer text-2xl"> Click here</a> to travel with us.</p>
